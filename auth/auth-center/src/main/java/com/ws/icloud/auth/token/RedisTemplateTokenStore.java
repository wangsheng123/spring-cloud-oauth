...
public class RedisTemplateTokenStore implements TokenStore {
    ...
    public RedisTemplateTokenStore(ObjectMapper objectMapper,@Qualifier("redisTemplateCustomize")  RedisTemplate redisTemplate) {
        redisTemplate.opsForValue().set("hh", new User("zhangsan", "sasa", new ArrayList<SimpleGrantedAuthority>()));
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        if (authentication.getUserAuthentication() instanceof UsernamePasswordAuthenticationToken) {
            ...
            params.put("auth",  account );
            params.put("authorities", account.getAuthorities());
        }
